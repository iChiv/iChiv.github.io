...
category: Reviews
date: 2022-09-07
description: "Analysis of Nintendo's fitness RPG — how smart gamification turns exercise into an engaging gameplay loop"
thumbnail: /assets/images/reviews/ring-fit-cover.jpg
tags: [Analysis, Game Design, Nintendo, Fitness, RPG]
lang: en
---
...
- **Player Character:** The character that players play as in the game does not have an official name. In *Super Smash Bros. Ultimate*, Nintendo named the figure *Ring Fit Trainee*.
- This character opens the game by recklessly unlocking Dragaux's seal at the beginning of the game.

- **NPC — Ring:** Ring is the character that guides the player through the game, and it is also the Ring-con in the player's hands.
- Ring has five abilities to help players on their adventures.

| Ability | Effect |
|---------|--------|
| Color Coding | Matching the attack with the enemy color makes said attack stronger |
| Smoothiecraft | Allows the player to make Smoothies |
| River Rowing | Allows the player to traverse long stretches of water |
| Jump Boost | Allows the player to flip during a jump by jumping twice in rapid succession |
| Wing Ability | Allows the player to cross any chasm |
...
- **Enemies — The Four Masters:** The four masters have been conquered by Dragaux and have blocked the player from challenging him on several occasions on his way to adventure.

| Master | Title |
|--------|-------|
| Allegra | The Legs Master |
| Abdonis | The Abs Master |
| Armando | The Arms Master |
| Guru Andma | The Yoga Master |

### 3.2 Level Exploration

The scenes in the game are divided into two categories: **worlds and levels.**

- **World:** The player moves through the worlds by walking the grid. There are 23 worlds in the game for players to explore. Players can mix Smoothies in the world screen.
...
- **Skills:** Skills are how characters attack or recover in battle.
...
**Legs (11):** Squat / Knee Lift / Thigh Press / Wide Squat / Hip Lift / Ring Raise Combo / Overhead Squat / Mountain Climber / Side Step / Knee-Lift Combo

**Yoga (10):** Chair Pose / Warrior I Pose / Fan Pose / Warrior II Pose / Revolved Crescent Lunge Pose / Warrior III Pose / Hinge Pose / Tree Pose / Standing Forward Fold / Boat Pose
...
- **Level design:** Some levels will emphasise the repetition of a certain move, but will evolve through mechanics to present the same move as a different organ. For example, levels that emphasise deep squats will see the player face simple bouncing organs — springs that repeat deep squats — swings that deep squat in rhythm — and deep squat power cars.
...
- **Sports assistance:** Players can choose their own exercise intensity to prevent them from giving up on the game because it is too difficult.
